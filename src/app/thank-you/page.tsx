...
export default function ThankYouPage() {
  ...
  return React.createElement('div', { className: 'min-h-screen bg-[#F5F1E8] flex items-center justify-center px-4' },
    React.createElement('div', { className: 'bg-white rounded-3xl p-12 text-center max-w-lg shadow-xl' },
      ...
      React.createElement('p', { className: 'text-sm text-gray-500 mb-8' }, 'For any queries, contact info@nomnothobeautystudio.co.za or WhatsApp 0761286545'),
